  ...
  return (
    <div className="min-h-screen bg-gradient-hero flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <Card className="backdrop-blur-sm bg-white/95 shadow-2xl border-white/20">
          <CardHeader className="space-y-1 text-center">
            <CardTitle className="text-2xl font-bold">Join FreelanceHub</CardTitle>
            <CardDescription>
                ...
                <RadioGroup defaultValue="client" className="grid grid-cols-2 gap-4">
                  <div className="flex items-center space-x-2 p-3 border rounded-lg cursor-pointer hover:bg-muted/50">
                    ...
                    <Label htmlFor="client" className="cursor-pointer">
                      ...
                      <div className="text-xs text-muted-foreground">I'm a client looking for talent</div>
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2 p-3 border rounded-lg cursor-pointer hover:bg-muted/50">
                    ...
                    <Label htmlFor="freelancer" className="cursor-pointer">
                      ...
                      <div className="text-xs text-muted-foreground">I'm looking for work</div>
                    </Label>
                  </div>
                </RadioGroup>
              </div>
